...
import com.netcracker.edu.varabey.service.InventoryService;
...
public class InventoryDatabaseTests {
    ...
    public void createOrderAndSaveItToDataBaseTest() {
        Order o1 = getO1();
        o1 = service.createOrder(o1);

        Order o2 = service.findOrder(o1.getId());
        assertNotNull(o2);
    ...
    public void addAndRemoveOrderItemsUpdateTest() {
        ...
        cu1.getOrders().forEach( o -> assertNull(service.findOrder(o.getId())));
